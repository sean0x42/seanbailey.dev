...
Messenger was widely used across my high school campus, but few students were
...
alternative platform that emphasised privacy and security.
...
This marked the first time I had ever built a dynamic web application, and I
couldn't be more proud of the result. I still remember the first time I managed
to send a message to a friend via the service.
...
The messenger home page was my first deep dive into building a product page. It
may not look like much, but I spent many, many hours painstakingly piecing this
together by hand.
...
utter gibberish. This screenshot was taken the first time I got messaging
...
within a drop down menu on smaller screens.
